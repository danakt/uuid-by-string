...
describe('Test algorithm no changes', function() {
  ...
  it('One char string', function() {
    expect(getUUID('.')).toBe('565e8432-1fb2-4687-8338-5b8e3a56c6cf')
  })

  it('Short string', function() {
    expect(getUUID('Hello, world!')).toBe(
      '92786d7e-b695-462f-809a-816218c24efc'
    )
  })

  it('Short string utf-8', function() {
    expect(getUUID('Привет, мир!')).toBe('4e07e9e1-b6f0-452f-a358-312606bd682a')
  })
  ...
  it('Long string', function() {
    ...
    expect(getUUID(str)).toBe('2922f43a-2bdc-4d2f-84ec-278473f4e7da')
  })
})
...
describe('Self equaling generated UUID', function() {
  describe('Short strings', function() {
    it('Morbi sit amet lobortis libero', function() {
      ...
      expect(getUUID(str)).toBe(getUUID(str))
    })
